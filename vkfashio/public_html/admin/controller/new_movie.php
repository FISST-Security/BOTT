...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$movie_price = cleardata($_POST['price']);
	...
	$statment = $connect->prepare( 
		...
		"INSERT INTO movies (movie_id,movie_title,movie_description,movie_year,movie_duration,movie_stars,movie_trailer,movie_link,movie_status,movie_date,movie_featured, movie_slug, movie_image,other_time,valid_time,edge_node_id,movie_price) VALUES (null, :movie_title, :movie_description, :movie_year, :movie_duration, :movie_stars, :movie_trailer, :movie_link, :movie_status, CURRENT_TIMESTAMP, :movie_featured, :movie_slug, :movie_image,:other_time,:valid_time,:edge_node_id,:movie_price)"
