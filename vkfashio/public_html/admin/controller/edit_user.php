...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$password = cleardata($_POST['user_password']);
      ...
      $user_package = cleardata($_POST['user_package']);
...
$statment = $connect->prepare(
	...
	"UPDATE users SET package =:user_package,edgeNode =:user_node, user_id = :user_id, user_name = :user_name, user_email = :user_email, user_status = :user_status, user_password = :user_password, user_updated = CURRENT_TIME WHERE user_id = :user_id"
