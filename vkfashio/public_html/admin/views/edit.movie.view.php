             ...
             <div class="form-group col-md-6">
               ...
               <label class="control-label">Edge Node</label>
                ...
                <select class="custom-select form-control time_val">
                     <option <?php if(!empty($movie['valid_time'])){echo 'selected';} ?> value="all_ways" selected>All Ways</option>
                     <option <?php if(!empty($movie['other_time'])){echo 'selected';} ?> value="other"  >Other</option>
                   </select>
                 </div>
                ...
                <input id="valid_time" value="allways" class="form-control" name="valid_time_v" type="hidden" required="">
                  ...
                  <input id="other_time" class="form-control" name="other_time_v" type="text"  value="<?php echo $movie['other_time'];?>"> <sapn class="remove_button">Remove</sapn>
               ...
               <div class="form-group col-md-6">
                    <label>Price</label>
                    <input class="form-control" value="<?php echo $movie['movie_price'];?>" name="price" type="number" required="">
                  </div>
