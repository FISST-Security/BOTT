      ...
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <option <?php if($usr['package'] == $row["id"]){echo "selected";}?>  value="<?php echo $row["id"]; ?>"><?php echo $row["package_title"]; ?></option>
                       <?php } } ?>
                     ...
                     <option value="" selected>- Select -</option>
                      <?php
                        ...
                        $sql = "SELECT * FROM edge_node";
                         ...
                         if ($result->num_rows > 0) {
                      while($row = $result->fetch_assoc()) {?>
            <option <?php if($usr['edgeNode'] == $row["id"]){echo "selected";}?>  value="<?php echo $row["id"]; ?>"><?php echo $row["edgeName"]; ?></option>
                       <?php } } ?>
