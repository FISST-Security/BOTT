    ...
    <div class="navigation-menu">
        ...
        <ul class="menu-items custom-scroll">
            ...
            <li>
                ...
                <a href="<?php echo _SITE_URL ?>/admin/controller/packages.php">

                    <span class="icon-thumbnail"><i class="fa fa-user-plus" aria-hidden="true"></i></span>

                    <span class="title">Member Packages</span>
             ...
             <li>
                ...
                <a href="<?php echo _SITE_URL ?>/admin/controller/edgeNode.php">

                    <span class="icon-thumbnail"><i class="fa fa-user-plus" aria-hidden="true"></i></span>

                    <span class="title">Manage Edge Node</span>
