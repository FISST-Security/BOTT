                    ...
                    <article class="uk-comment uk-position-relative">
                        <header class="uk-comment-header">
                            <div class="uk-user-menu">
                                <div class="uk-text-contrast uk-text-middle uk-display-inline-flex uk-text-left dropdown-btn">
                                ...
                                <div class="uk-subnav-sub">
                                    <ul class="uk-users">
                                        <li><a href="#"><img src="https://creativeitem.com/demo/neoflex/assets/global/thumb1.png"/> User testing</a></li>
                            ...
                            <h4 class="uk-comment-title uk-text-contrast uk-text-truncate">
