...
if($link === false){
 ...
 $sql_pay = "SELECT * FROM  payment where user_id='".$parent_id."' AND series='series'";
...
$result_get_in = $link->query($sql_get_in);
 ...
 $sql_get = "SELECT * FROM  series_view where user_id='".$parent_id."' AND movie_id='".$movie_id."'";
 $result_get = $link->query($sql_get);
 if ($result_get->num_rows > 0) {
  while($result_get_row = $result_get->fetch_assoc()) {
    //print_r($row);
        $update_id = $result_get_row['id'];
        $update_movie_id = $result_get_row['sereis_id'];
  }
}
...
if (r == true) {
  window.location.href = 'http://www.vkfashion.co.in/payumoney?user_id=<?php echo $parent_id; ?>&type=<?php echo 'series'?>'; 
                ...
                <div class="uk-container uk-container-center uk-width-10-10">
                    ...
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-medium-3-10"> 
                            ...
                            <?php
 if (($result_get_in->num_rows < $movie_number) || ($update_movie_id == $movie_id))  {?>
