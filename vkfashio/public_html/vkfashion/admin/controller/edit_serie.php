...
$statment = $connect->prepare(
	...
	'UPDATE series SET serie_title = :serie_title, serie_description = :serie_description, serie_year = :serie_year, serie_status = :serie_status, serie_featured = :serie_featured, serie_trailer = :serie_trailer, serie_stars = :serie_stars, serie_image = :serie_image,other_time=:other_time,valid_time=:valid_time,edge_node_id=:edge_node_id WHERE serie_id = :serie_id'
