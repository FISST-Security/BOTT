...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$statment = $connect->prepare(
		...
		'INSERT INTO series (serie_id,serie_title,serie_description,serie_year,serie_status,serie_featured,serie_trailer,serie_stars,serie_slug,serie_date,serie_image,other_time,valid_time,edge_node_id) VALUES (null, :serie_title, :serie_description, :serie_year, :serie_status, :serie_featured, :serie_trailer, :serie_stars, :serie_slug, CURRENT_TIME, :serie_image,:other_time,:valid_time,:edge_node_id)'
